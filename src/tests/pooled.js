...
class FatEventTest extends React.Component {
  state = { counter: 0 };
  increment = () =>
  ...
  render() {
    ...
    const recurse =
      depth > 1 ? <FatEventTest depth={depth - 1} called={called} /> : null;
...
export default root => {
  return () => {
    ...
    ReactDOM.render(<FatEventTest depth={100} called={called} />, root);
